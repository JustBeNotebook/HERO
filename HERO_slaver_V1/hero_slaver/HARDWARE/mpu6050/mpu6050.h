...
typedef struct MPU6050_Module
{
  ...
  short	gyroy;
	...
	float chip_pitch;
	float chip_roll;
	float chip_yaw;		//角度值   pitch 是俯仰角度 前倾为负， roll是横滚角度 右低为负，yaw是偏航角度 顺时针为负
...
extern MPU6050_Module MPU6050_MK1;
extern MPU6050_Module MPU6050_Gimbal;
